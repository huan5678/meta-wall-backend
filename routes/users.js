...
router.post(
    ...
    */
    ...
    '/user/login', userController.userLogin);
router.post(
    /*  
    #swagger.tags = ['Users  -  使用者']
    #swagger.description = '使用者變更密碼頁面 API'
    ...
    */
    ...
    '/user/update_password', isAuthor, userController.updatePassword);
router.get(
    /* 
        #swagger.tags = ['Users  -  使用者'] 
    ...
    */
    ...
    '/user/profile', isAuthor, userController.getProfile);
router.patch(
    /* 
        #swagger.tags = ['Users  -  使用者'] 
    ...
    */
    ...
    '/user/profile', isAuthor, userController.updateProfile);
